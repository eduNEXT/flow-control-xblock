""" Flow Control Xblock allows to evaluate a condition and based on the outcome either display the unit's content or take an alternative action """
...
def _actions_generator(block):  # pylint: disable=unused-argument
    """ Generates a list of possible actions to take when the condition is met """
...
class FlowCheckPointXblock(StudioEditableXBlockMixin, XBlock):
    ...
    action = String(display_name="Action",
                    help="Select the action to be performed when the condition is met",
                    scope=Scope.content,
    ...
    ref_value = Integer(help="Enter the value to be used in the comparison. (From 0 to 100)",
                        default=0,
                        scope=Scope.content,
    ...
    target_url = String(help="URL to redirect to, supports relative or absolute urls",
                        scope=Scope.content,
    ...
    message = String(help="Message for the learners to view when the condition is met",
                     scope=Scope.content,
                     default='',
                     display_name="Message",
                     multiline_editor='html')

    problem_id = String(help="Problem id to use for the condition. (Not the complete problem locator. Only the 32 characters alfanumeric id. Example: 618c5933b8b544e4a4cc103d3e508378)",
                        scope=Scope.content,
                        display_name="Problem id")

    list_of_problems = String(help="List of problems ids separated by commas or line breaks."
                              "(Not the complete problem locators. Only the 32 characters alfanumeric ids. Example: 618c5933b8b544e4a4cc103d3e508378, 905333bd98384911bcec2a94bc30155f)"
                              "The simple average score for all problems will be used.",
                              scope=Scope.content,
